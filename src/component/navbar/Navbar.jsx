      ...
      <Flex bg="#2d2d2d" alignItems="center">
        <Flex className={navStyles.hamburger}>
          <Box>
            ...
            />
            {clicked && (
              <DrawerExample clicked={clicked} setClicked={setClicked} />
            )}
          </Box>
        </Flex>
        ...
        <Flex className={navStyles.input}>
          <Box>
            <Input
              className={navStyles.inputfiled}
              padding="23px"
              bg="white"
        ...
        >
          <Box color="white" display="flex" alignItems="center">
            {email != "" ? (
              <Avatar name={email} src="https://bit.ly/broken-link" />
            ) : (
